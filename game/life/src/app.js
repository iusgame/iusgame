...
class App{
    ...
    initPages() {
        ...
        <div id="main">
            ...
            <button class="sponsor" onclick="globalThis.open('https://www.itudouni.top')" style="background: linear-gradient(90deg,#946ce6,#7e5fd9); left:auto; right:50%; transform: translate(-2rem,-50%);">百度搜索：悠技互娱</button>
            <button class="sponsor" onclick="globalThis.open('https://www.itudouni.top')" style="background-color:#c69; left:50%; right:auto; transform: translate(2rem,-50%);">百度搜索：悠技互娱</button>
        </div>
        `);
