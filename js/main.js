...
$(function() {
  var bookmark = {
    data: [{
      ...
      name: '悠技app',
      link: 'https://www.itudouni.top/download/download.htm',
      icon: 'img/down.png',
    }]
  }
  ...
  $(document).click(function(e) {
    ...
    for (var i = 0; i < search.data.length; i++) {
      if (id == search.data[i].name) {
        ...
        document.getElementById("Select").innerHTML = "<hr>热门 <img src='img/search-change.svg?v=2ae7ab8'>";
...
var time = d.getHours();
if (time > 5) {
  document.getElementById("title").innerHTML = "悠技导航 | 新的一天开始咯^o^";
}
if (time > 10) {
  document.getElementById("title").innerHTML = "悠技导航 | 中午要好好休息>_<";
}
if (time > 13) {
  document.getElementById("title").innerHTML = "悠技导航 | 下午过的怎么样o_O";
}
if (time > 18) {
  document.getElementById("title").innerHTML = "悠技导航 | 晚上记得吃饱~";
}
if (time > 21) {
  document.getElementById("title").innerHTML = "悠技导航 | 夜深了早点睡Zzz";
}
if (time < 6) {
  document.getElementById("title").innerHTML = "悠技导航 | 还不睡？修仙呢！！";
}
//title问候语结束

//导航、引擎选择器
function select() {
  $('#folder').css('display') == 'block' ? ($('#folder').css('display', 'none'), $('#nav').css('display', 'block'), document.getElementById("Select").innerHTML = "<hr>搜索引擎 <img src='img/search-change.svg?v=2ae7ab8'>") : ($('#nav').css('display', 'none'), $('#folder').css('display', 'block'), document.getElementById("Select").innerHTML = "<hr>热门 <img src='img/search-change.svg?v=2ae7ab8'>");
}
